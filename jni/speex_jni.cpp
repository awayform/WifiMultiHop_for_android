...
extern "C" JNIEXPORT jint JNICALL Java_com_xd_wifimultihop_business_speex_Speex_open(JNIEnv *env,
...
extern "C" JNIEXPORT jint Java_com_xd_wifimultihop_business_speex_Speex_encode(JNIEnv *env,
...
extern "C" JNIEXPORT jint JNICALL Java_com_xd_wifimultihop_business_speex_Speex_decode(
...
extern "C" JNIEXPORT jint JNICALL Java_com_xd_wifimultihop_business_speex_Speex_getFrameSize(
...
extern "C" JNIEXPORT void JNICALL Java_com_xd_wifimultihop_business_speex_Speex_close(JNIEnv *env,
		jobject obj) {
...
extern "C" JNIEXPORT jint JNICALL Java_com_xd_wifimultihop_business_speex_Speex_echoinit(
...
extern "C" JNIEXPORT jint JNICALL Java_com_xd_wifimultihop_business_speex_Speex_echoplayback(
...
extern "C" JNIEXPORT jint JNICALL Java_com_xd_wifimultihop_business_speex_Speex_echocapture(
...
extern "C" JNIEXPORT void JNICALL Java_com_xd_wifimultihop_business_speex_Speex_echoclose(
		JNIEnv *env, jobject obj) {
	if (--eco_open != 0)
		return;
...
extern "C" JNIEXPORT void JNICALL Java_com_xd_wifimultihop_business_speex_Speex_echocancel(
		JNIEnv *env, jobject obj, jshortArray rec, jshortArray play,
		jshortArray out) {
	if (!eco_open)
		return;
	jshort temp_play[eco_frame_size];
	jshort temp_rec[eco_frame_size];
	jshort temp_out[eco_frame_size];
	env->GetShortArrayRegion(play, 0, eco_frame_size, temp_play);
	env->GetShortArrayRegion(rec, 0, eco_frame_size, temp_rec);
	speex_echo_cancellation(echostate, temp_rec, temp_play, temp_out);
	env->SetShortArrayRegion(out, 0, eco_frame_size, temp_out);
}
